...
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"7b3149746e5b58243f2e3928424a4873",text_dir:"ltr",LimitChars:"50",pftext:"P",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpmyadmin/",arg_separator:"&",version:"5.2.1",auth_type:"config",user:"root"});
...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=test_salna&table=barang">
    `test_salna`.`barang`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=laravel&table=akses">
    `laravel`.`akses`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=laravel&table=orders">
    `laravel`.`orders`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=laravel&table=users">
    `laravel`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=laravel&table=orders_user">
    `laravel`.`orders_user`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          ...
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=laravel"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=laravel" title="Structure">laravel</a>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander loaded container" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.dGVzdA==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
  ...
  <li class="database last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.dGVzdF9zYWxuYQ==" data-vpath="cm9vdA==.dGVzdA==.c2FsbmE=" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=test_salna"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=test_salna" title="Structure">test_salna</a>
  ...
  <li class="last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.dXNlcmJhZ2lhbg==" data-vpath="cm9vdA==.dXNlcmJhZ2lhbg==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=userbagian"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=userbagian" title="Structure">userbagian</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7b3149746e5b58243f2e3928424a4873">
  ...
  <div id="pma_console_container" class="d-print-none">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="test_salna" targettable="barang">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `test_salna`.`barang` (`id` INT NOT NULL AUTO_INCREMENT , `nama` VARCHAR(50) NOT NULL , `stock` INT(15) NOT NULL , `harga` INT(15) NOT NULL , `deskripsi` VARCHAR(200) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="test_salna" targettable="barang">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `barang` (`id`, `nama`, `stock`, `harga`, `deskripsi`) VALUES (NULL, &#039;Beras Type Biru&#039;, &#039;100&#039;, &#039;12600&#039;, &#039;Beras type ini berupa beras yang disaring agar pecahan beras berkurang.&#039;);</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `barang` (`id`, `nama`, `stock`, `harga`, `deskripsi`) VALUES (NULL, &#039;Beras Type Merah&#039;, &#039;100&#039;, &#039;12400&#039;, &#039;Beras Type ini berupa beras yang tidak melalui pesaringan dan pecahan beras dijadikn satu.&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="test_salna" targettable="barang">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `barang` (`id`, `nama`, `stock`, `harga`, `deskripsi`) VALUES (NULL, &#039;Beras Type Hijau&#039;, &#039;100&#039;, &#039;12200&#039;, &#039;Beras type ini adalah beras yang kualitasnya berada dibawah beras type merah.&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="test_salna" targettable="barang">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `barang` (`id`, `nama`, `stock`, `harga`, `deskripsi`) VALUES (NULL, &#039;Pecah Kulit&#039;, &#039;1700&#039;, &#039;10300&#039;, &#039;Hasil olahan padi yang telah dikupas kulitnya.&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="test_salna" targettable="barang">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `barang` (`id`, `nama`, `stock`, `harga`, `deskripsi`) VALUES (NULL, &#039;Katul/Bekatul&#039;, &#039;100&#039;, &#039;4500&#039;, &#039;Hasil tambahan dari hasil olahan pecah kulit menjadi beras.&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test_salna" targettable="barang">
                            <div class="action_content">
